      ...
      <div className="flex flex-col md:flex-row gap-4">
        <div className="relative flex-1">
          ...
          <Input
            ...
            className="pl-10 bg-accent/50 border-border text-foreground h-11 focus:border-primary/50"
          />
        </div>
        <div className="flex gap-2">
          ...
          <select className="bg-accent/50 border border-border text-foreground h-11 px-4 rounded-md focus:border-primary/50 outline-none text-sm appearance-none">
            <option className="bg-popover text-popover-foreground">
              {t_common("allPositions")}
            </option>
          </select>
        </div>
      </div>
