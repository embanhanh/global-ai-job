      ...
      <AnimatePresence mode="wait">
        {!isScanning ? (
          ...
          >
            ...
            >
              <div className="p-4 rounded-2xl bg-accent border border-border group-hover:scale-110 transition-transform duration-300">
            ...
            {isDragActive && (
              <div className="absolute inset-0 bg-primary/10 rounded-2xl flex items-center justify-center backdrop-blur-[2px]">
                <p className="text-primary font-bold">{t("dropActive")}</p>
              </div>
            )}
          </div>
        ) : (
          <motion.div
            ...
            className="py-12 px-6 rounded-3xl border-2 border-primary/30 bg-primary/5 flex flex-col items-center text-center gap-6"
          >
            ...
            <div className="space-y-2">
              ...
              <p className="text-muted-foreground">{t("extracting")}</p>
            </div>
            <div className="w-full max-w-xs h-1 px-1 bg-accent rounded-full overflow-hidden">
              <motion.div
                initial={{ width: 0 }}
                animate={{ width: "100%" }}
